...
ENGINE="${CODEX_NEWSKIN_ENGINE:-$HOME/.codex/codex-newskin}"
...
START="$SCRIPTS/start-newskin-macos.sh"
PAUSE="$SCRIPTS/pause-newskin-macos.sh"
CUSTOMIZE="$SCRIPTS/customize-theme-macos.sh"
RESTORE="$SCRIPTS/restore-newskin-macos.sh"
STATUS="$SCRIPTS/status-newskin-macos.sh"
