...
Codex Newskin `1.0.0` passed its macOS release checks on the live Codex desktop app during the original private release validation.
...
```bash
~/.codex/codex-newskin/scripts/verify-newskin-macos.sh \
  --reload --screenshot "$HOME/Desktop/Codex Newskin Verification.png"
```
